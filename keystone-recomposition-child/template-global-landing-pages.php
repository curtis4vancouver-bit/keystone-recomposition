<?php
/**
 * Template Name: Keystone Global Landing Pages Hub
 * Description: International Longevity, Executive Advisory, and Luxury Compound Investment Hub
        ...
        <div class="ast-container">
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <div class="entry-content clear">
                    <div class="tool-header text-center" style="margin: 40px auto 40px auto; max-width: 800px;">
                        <span class="tool-badge">GLOBAL EXECUTIVE ADVISORY</span>
                        <h1 style="font-family:'Outfit', sans-serif; font-size:clamp(26px, 4vw, 38px); font-weight:800; color:#FFFFFF; text-transform:uppercase; margin-bottom:15px; letter-spacing:0.02em;">International Longevity &amp; Private Protocols</h1>
                        <p style="font-size:15px; color:#9CA3AF; line-height:1.6; margin:0 auto;">Discrete, data-driven metabolic coaching, peptide procurement consulting, and private alpine retreat developments for high-net-worth executives across premier global markets.</p>
                    </div>

                    <!-- Global Hub Grid -->
                    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(320px, 1fr)); gap:25px; margin-bottom:60px;">
                        
                        <!-- Card 1: New York -->
                        <div style="background:#111111; border:1px solid rgba(196,162,101,0.25); border-radius:10px; padding:30px 25px; display:flex; flex-direction:column; justify-content:space-between;">
                            <div>
                                <span style="font-size:10px; font-weight:800; letter-spacing:0.12em; color:#C4A265; text-transform:uppercase;">UNITED STATES • EAST COAST</span>
                        ...
                        <div style="background:#111111; border:1px solid rgba(196,162,101,0.25); border-radius:10px; padding:30px 25px; display:flex; flex-direction:column; justify-content:space-between;">
                            <div>
                                <span style="font-size:10px; font-weight:800; letter-spacing:0.12em; color:#C4A265; text-transform:uppercase;">UNITED STATES • WEST COAST</span>
                        ...
                        <div style="background:#111111; border:1px solid rgba(196,162,101,0.25); border-radius:10px; padding:30px 25px; display:flex; flex-direction:column; justify-content:space-between;">
                            <div>
                                <span style="font-size:10px; font-weight:800; letter-spacing:0.12em; color:#C4A265; text-transform:uppercase;">UNITED KINGDOM &amp; EUROPE</span>
                        ...
                        <div style="background:#111111; border:1px solid rgba(196,162,101,0.25); border-radius:10px; padding:30px 25px; display:flex; flex-direction:column; justify-content:space-between;">
                            <div>
                                <span style="font-size:10px; font-weight:800; letter-spacing:0.12em; color:#C4A265; text-transform:uppercase;">SWITZERLAND &amp; EU</span>
                        ...
                        <div style="background:#111111; border:1px solid rgba(196,162,101,0.25); border-radius:10px; padding:30px 25px; display:flex; flex-direction:column; justify-content:space-between;">
                            <div>
                                <span style="font-size:10px; font-weight:800; letter-spacing:0.12em; color:#C4A265; text-transform:uppercase;">MEXICO &amp; LATIN AMERICA</span>
